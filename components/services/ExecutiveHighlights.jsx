...
export default function ExecutiveHighlights({ serviceId }) {
  ...
  const filteredHighlights = executionHighlights.filter(
    (executionHighlights) => executionHighlights.service._id === serviceId
  );
          ...
          <div className="col-auto">
            <div className="sectionTitle ">
              ...
              <p className="sectionTitle__text ">
                Executive highlights succinctly summarize key accomplishments,
                providing stakeholders with a snapshot of significant
